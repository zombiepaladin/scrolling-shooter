...
namespace ScrollingShooter
{
    ...
    /// </summary>
    public class AlienTurretOrbScrolling : Projectile
    {
        // Orb state variables
        ...
        public AlienTurretOrbScrolling(uint id, ContentManager content, Vector2 position)
            : base(id)
        {
        ...
        {
            position += angleVector*elapsedTime*200;
